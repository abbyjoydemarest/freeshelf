# Generated by Django 2.1.7 on 2019-03-13 21:32
...
def load_book_data(apps, schema_editor):
    ...
    with open(datafile) as file:
        ...
        for row in reader:
            ...
            author, _ = Author.set().objects.get_or_create(author=row['author'])
            book_category, _ = Category.objects.get_or_create(book_category=row['book_category'])
